...
const Footer = () => {
  return (
    <footer className="bg-white mx-auto h-max pb-20 max-sm:hidden">
      <div className="mx-auto text-black-300 md:container">
            ...
            <div className="grid grid-cols-3 gap-2 pb-4">
              ...
              >
                <g clip-path="url(#clip0_4_9003)">
                  ...
                  />
                  <path
                    d="M14.8999 19.8665V14.5332L19.1666 17.2L14.8999 19.8665Z"
                    fill="#FF0000"
                  />
                </g>
                <defs>
        ...
        <div className="border-y-slate-300 border-y-4 pt-4 pb-5 text-slate-500 text-lg">
          <h1 className="text-2xl font-semibold pb-5 text-black">
            Công ty TNHH TIKI
          </h1>
          <p>
          ...
          <p>
            Hotline:{" "}
            <span className="text-blue-600 font-medium">1900 6035</span>
          </p>
        </div>
      </div>
    </footer>
