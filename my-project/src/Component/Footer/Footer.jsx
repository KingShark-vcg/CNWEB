...
const Footer = () => {
  return (
    <footer className="bg-white mx-auto h-max pb-20">
        <div className="mx-auto text-black-300 md:container">
            <div className="flex pt-10 pb-10 space-x-20">  
                <div>
                    <h1 className="text-2xl font-semibold pb-5">Hỗ trợ khách hàng</h1>
                    <ul className="text-slate-500 text-lg">
                        <li>Hotline: 1900-6035 <br />
                ...
                <div>
                    <h1 className="text-2xl font-semibold pb-5">Về Tiki</h1>
                    <ul className="text-slate-500 text-lg">
                ...
                <div>
                    <h1 className="text-2xl font-semibold pb-5">Hợp tác và liên kết</h1>
                    <ul className="text-slate-500 text-lg pb-10">
                        <li>Quy chế hoạt động Sàn GDTMĐT</li>
                        <li>Bán hàng cùng Tiki</li>
                    </ul>
                    <h1 className="text-2xl font-semibold pb-3">Chứng nhận bởi</h1>
                    <img src="https://frontend.tikicdn.com/_desktop-next/static/img/footer/bo-cong-thuong.svg" alt=""/>
                </div> 
                <div>
                    <h1 className="text-2xl font-semibold pb-5">Phương thức thanh toán</h1>
                    <h1 className="text-2xl font-semibold pb-5">Dịch vụ giao hàng</h1>
                </div> 
                <div>
                    <h1 className="text-2xl font-semibold pb-5">Kết nối với chúng tôi</h1>
                    <div className="grid grid-cols-3 gap-2 pb-4">
                    <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-12">
                        <g clip-path="url(#clip0_4_9000)">
                        <path d="M0.5 16.6665C0.5 7.82995 7.66344 0.666504 16.5 0.666504C25.3366 0.666504 32.5 7.82995 32.5 16.6665C32.5 25.5031 25.3366 32.6665 16.5 32.6665C7.66344 32.6665 0.5 25.5031 0.5 16.6665Z" fill="#3B5998"/>
                        <path d="M18.1676 26.0742V17.3693H20.5706L20.889 14.3696H18.1676L18.1717 12.8682C18.1717 12.0858 18.2461 11.6666 19.3698 11.6666H20.872V8.6665H18.4687C15.582 8.6665 14.566 10.1217 14.566 12.5689V14.3699H12.7666V17.3696H14.566V26.0742H18.1676Z" fill="white"/>
                        </g>
                        <defs>
                    ...
                    <h3 className="text-xl font-semibold pb-5">Tải ứng dụng trên điện thoại</h3>
                </div>
            </div>
            <div className="border-y-slate-300 border-y-4 pt-4 pb-5 text-slate-500 text-lg">
                <h1 className="text-2xl font-semibold pb-5 text-black">Công ty TNHH TIKI</h1>
